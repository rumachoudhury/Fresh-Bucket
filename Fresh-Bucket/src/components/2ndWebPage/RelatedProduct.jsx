...
function RelatedProduct() {
  ...
  let products = [
    {
      discunt25: "/images/fresh-bucket-images/25.png",
      image: "/images/fresh-bucket-images/fresh-plate.png",
      title: "Organic Tomatoes",
      price: "$24.99",
      original_pric: "$39.07",
      backgroundColor: "#F9F8E6",
    ...
    {
      discunt25: "/images/fresh-bucket-images/25.png",
      image: "/images/fresh-bucket-images/apple.png",
      title: "Organic Orange",
      price: "$30.00",
      original_pric: "$40.00",
      backgroundColor: "#F9F8E6",
    ...
    {
      discunt25: "/images/fresh-bucket-images/25.png",
      image: "/images/fresh-bucket-images/cabbage.png",
      title: "Organic Strawberries",
      price: "$20.00",
      original_pric: "$35.00",
      backgroundColor: "#F9F8E6",
    ...
    {
      discunt25: "/images/fresh-bucket-images/25.png",
      image: "/images/fresh-bucket-images/green.png",
      title: "Organic Apple",
      price: "$15.00",
      original_pric: "$25.00",
      backgroundColor: "#F9F8E6",
  ...
  return (
    <div className="container mx-auto p-6 ">
      ...
      <div className="flex items-center justify-between  p-6  py-10 px-6">
        <div className="">
          ...
          <div className="text-center flex-1">
            <h3 className="text-4xl font-bold text-black-500 mt-1">
              Related Product
            </h3>
          </div>
        </div>
      ...
      {/* product card 2nd section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-6 rounded-lg ">
